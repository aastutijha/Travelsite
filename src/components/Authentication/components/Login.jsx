...
const Login = () => {
  ...
  return (
    ...
    <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-centerjustify-center ">
      <div className="md:w-1/2 px-16">
        ...
        <svg className="mr-3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20px" height="25px" viewBox="0 0 48 48">
          ...
          </svg>  <p style={{ color: 'black' }}>Login With Google </p> </button>
      ...
      <div className="md:block hidden w-1/2">
        <img className="rounded-2xl py-12" src={IMG} alt="login_image" style={{width: '25%', height: 'auto'}}/>
      </div>
    </div>
  </section>
  );
