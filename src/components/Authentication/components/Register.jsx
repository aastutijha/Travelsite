    ...
    return (
        <section className="bg-gray-50 min-h-screen flex items-center justify-center">
            <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                <div className="w-full md:w-1/2 px-16 flex flex-col items-center">
                    ...
                    <form action="" className='flex flex-col gap-4 w-full' onSubmit={handleRegister}>
                    ...
                    <div className="mt-8 grid grid-cols-3 items-center text-gray-400 w-full">
                    ...
                    <p className="text-sm border-b border-gray-400 py-4 px-5 w-full text-center">Forgot Password?</p>
                    <div className="mt-3 text-sm flex justify-between items-center w-full">
                ...
                <div className="md:block hidden w-1/2 ">
                    <img className="rounded-2xl py-12" src={IMG} alt="login_image" style={{ width: '25%', height: 'auto' , left:'10px' }} />
                </div>
            </div>
        </section>
    );
